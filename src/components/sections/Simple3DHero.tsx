  ...
  return (
    <group>
      {[
        ...
        <Float key={index} speed={2} rotationIntensity={0.2} floatIntensity={0.3}>
          <Sphere args={[props.size, 16, 16]} position={props.position}>
...
export default function Simple3DHero() {
  return (
